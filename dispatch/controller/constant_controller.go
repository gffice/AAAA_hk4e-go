...
func (c *Controller) getAgreementInfos(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"marketing_agreements\":[]}}")
}
...
func (c *Controller) combo(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
...
func (c *Controller) getConfig(ctx *gin.Context) {
	...
	case "3":
		// Windows
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"protocol\":true,\"qr_enabled\":false,\"log_level\":\"INFO\",\"announce_url\":\"https://webstatic-sea.hoyoverse.com/hk4e/announcement/index.html?sdk_presentation_style=fullscreen\\u0026sdk_screen_transparent=true\\u0026game_biz=hk4e_global\\u0026auth_appid=announcement\\u0026game=hk4e#/\",\"push_alias_type\":2,\"disable_ysdk_guard\":false,\"enable_announce_pic_popup\":true}}")
	case "2", "1":
		// Android IOS
...
func (c *Controller) loadConfig(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	clientType := ctx.Query("client")
	switch clientType {
	case "3":
		// Windows
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":6,\"game_key\":\"hk4e_global\",\"client\":\"PC\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"fb\",\"tw\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000}},\"initialize_firebase\":false,\"bbs_auth_login\":false,\"bbs_auth_login_ignore\":[]}}")
	case "2":
		// Android
		// _, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":5,\"game_key\":\"hk4e_global\",\"client\":\"Android\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"gl\",\"fb\",\"tw\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{\"gl\":\"\",\"tw\":\"\",\"fb\":\"\"},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"gl\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800}},\"initialize_firebase\":false,\"bbs_auth_login\":false,\"bbs_auth_login_ignore\":[]}}")
		//_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":6,\"game_key\":\"hk4e_global\",\"client\":\"PC\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"fb\",\"tw\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{\"tw\":\"\",\"fb\":\"\"},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800},\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800}}}}")
		// _, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":6,\"game_key\":\"hk4e_global\",\"client\":\"PC\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"fb\",\"tw\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000}},\"initialize_firebase\":false,\"bbs_auth_login\":false,\"bbs_auth_login_ignore\":[]}}")
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":5,\"game_key\":\"hk4e_global\",\"client\":\"Android\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"fb\",\"tw\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{\"tw\":\"\",\"fb\":\"\"},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800},\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800}}}}")
	case "1":
		// IOS
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":4,\"game_key\":\"hk4e_global\",\"client\":\"IOS\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"原神海外\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"ap\",\"fb\",\"tw\",\"gc\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{\"ap\":\"\",\"fb\":\"\",\"gc\":\"\",\"tw\":\"\"},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"gc\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800},\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"ap\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800},\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000}},\"initialize_firebase\":true,\"bbs_auth_login\":false,\"bbs_auth_login_ignore\":[]}}")
	}
}
...
func (c *Controller) list(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"success\":true,\"message\":\"\",\"data\":[{\"code\":1000,\"type\":2,\"config_id\":\"14\",\"period_id\":\"6036_99\",\"version\":\"1\",\"configs\":{\"cardType\":\"old\"}}]}")
}
...
func (c *Controller) deviceExtList(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	platformType := ctx.Query("platform")
	switch platformType {
	case "3":
		// Windows
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"code\":200,\"msg\":\"ok\",\"ext_list\":[\"cpuName\",\"deviceModel\",\"deviceName\",\"deviceType\",\"deviceUID\",\"gpuID\",\"gpuName\",\"gpuAPI\",\"gpuVendor\",\"gpuVersion\",\"gpuMemory\",\"osVersion\",\"cpuCores\",\"cpuFrequency\",\"gpuVendorID\",\"isGpuMultiTread\",\"memorySize\",\"screenSize\",\"engineName\",\"addressMAC\"],\"pkg_list\":[]}}")
	case "2":
		// Android
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"code\":200,\"msg\":\"ok\",\"ext_list\":[\"oaid\",\"vaid\",\"aaid\",\"serialNumber\",\"board\",\"brand\",\"hardware\",\"cpuType\",\"deviceType\",\"display\",\"hostname\",\"manufacturer\",\"productName\",\"model\",\"deviceInfo\",\"sdkVersion\",\"osVersion\",\"devId\",\"buildTags\",\"buildType\",\"buildUser\",\"buildTime\",\"screenSize\",\"vendor\",\"romCapacity\",\"romRemain\",\"ramCapacity\",\"ramRemain\",\"appMemory\",\"accelerometer\",\"gyroscope\",\"magnetometer\"],\"pkg_list\":[\"com.miHoYo.GenshinImpact\",\"com.miHoYo.Yuanshen\",\"com.miHoYo.enterprise.HK4E\",\"com.miHoYo.enterprise.HK4E2\",\"com.miHoYo.genshinimpactcb\",\"com.miHoYo.yuanshencb\",\"com.miHoYo.bh3global\",\"com.miHoYo.bh3globalBeta\",\"com.miHoYo.bh3korea\",\"com.miHoYo.bh3korea.samsung\",\"com.miHoYo.bh3korea_beta\",\"com.miHoYo.bh3oversea\",\"com.miHoYo.bh3oversea.huawei\",\"com.miHoYo.bh3overseaBeta\",\"com.miHoYo.bh3rdJP\",\"com.miHoYo.bh3tw\",\"com.miHoYo.bh3twbeta\",\"com.miHoYo.bh3twmycard\",\"com.miHoYo.enterprise.NGHSoD\",\"com.miHoYo.enterprise.NGHSoDBak\",\"com.miHoYo.enterprise.NGHSoDBeta\",\"com.miHoYo.enterprise.NGHSoDQD\",\"com.miHoYo.HSoDv2.mix\",\"com.miHoYo.HSoDv2Beta\",\"com.miHoYo.HSoDv2Original\",\"com.miHoYo.HSoDv2OriginalENT\",\"com.miHoYo.tot.cht\",\"com.miHoYo.tot.glb\",\"com.miHoYo.wd\",\"com.miHoYo.cloudgames.ys\",\"com.miHoYo.cloudgames.ys.dev\",\"com.mihoyo.cloudgame\",\"com.mihoyo.cloudgamedev\",\"com.HoYoverse.enterprise.hkrpgoversea\",\"com.HoYoverse.hkrpgoversea\",\"com.HoYoverse.hkrpgoverseacbtest\",\"com.miHoYo.enterprise.hkrpg\",\"com.miHoYo.hkrpg\",\"com.miHoYo.hkrpgcb\",\"com.miHoYo.hkrpgoverseacb\"]}}")
	case "1":
		// IOS
		_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"code\":200,\"msg\":\"ok\",\"ext_list\":[\"IDFV\",\"model\",\"osVersion\",\"screenSize\",\"vendor\",\"cpuType\",\"cpuCores\",\"isJailBreak\",\"networkType\",\"proxyStatus\",\"batteryStatus\",\"chargeStatus\",\"romCapacity\",\"romRemain\",\"ramCapacity\",\"ramRemain\",\"appMemory\",\"accelerometer\",\"gyroscope\",\"magnetometer\"],\"pkg_list\":[]}}")
	}
}

// POST https://public-data-api.mihoyo.com/device-fp/api/getFp HTTP/1.1
func (c *Controller) deviceFp(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	deviceFp := ctx.Query("device_fp")
	_, _ = ctx.Writer.WriteString(fmt.Sprintf("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"device_fp\":\"%v\",\"code\":200,\"msg\":\"ok\"}}", deviceFp))
}
...
func (c *Controller) batch(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"success\",\"data\":null}")
}

// GET https://hk4e-sdk-os-static.hoyoverse.com/hk4e_global/combo/granter/api/getFont?app_id=4 HTTP/1.1
func (c *Controller) getFont(ctx *gin.Context) {
	ctx.Header("Content-type", "application/json")
	_, _ = ctx.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"fonts\":[]}}")
}

// GT

// GET https://account.hoyoverse.com/geetestV2.html HTTP/1.1
func (c *Controller) gtGeetestV2(ctx *gin.Context) {
	ctx.Header("Content-type", "text/html")
	_, _ = ctx.Writer.WriteString("<!DOCTYPE html><html lang=\"en\"><head></head><body></body></html>")
}

// Android GT

// GET https://static.geetest.com/favicon.ico HTTP/1.1
func (c *Controller) gtFaviconIco(ctx *gin.Context) {
...
func (c *Controller) gtAjax(ctx *gin.Context) {
	ctx.Header("Content-type", "text/javascript;charset=UTF-8")
	callback := ctx.Query("callback")
	if len(callback) == 0 {
		_, _ = ctx.Writer.WriteString("{\"status\": \"success\", \"data\": {\"result\": \"slide\"}}")
	} else {
		_, _ = ctx.Writer.WriteString(callback + "({\"success\": 1, \"message\": \"success\", \"validate\": \"af90d1ba691970f759a3c60c908c1499\", \"score\": \"1\"})")
	}
}
